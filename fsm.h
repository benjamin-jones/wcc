/*
 * File: fsm.h
 * Purpose: Implements a generic finite state machine based on an
 *          implementation by Ankur Shrivastava (http://http://ankurs.com/2010/04/simple-finite-state-machines-in-c/)
 */
